...
export default function BoxTools({ tools, shelf, shelves, boxes, onEditTool, onDeleteTool, }) {
    const [selectedImage, setSelectedImage] = useState(null);
    return (_jsxs("section", { style: { marginTop: "1rem" }, children: [_jsx("h3", { children: "Werkzeuge" }), tools.length === 0 && (_jsx("p", { style: { opacity: 0.6 }, children: "Keine Werkzeuge in dieser Kiste" })), tools.map((tool) => (_jsxs("div", { style: {
                    padding: "0.5rem",
